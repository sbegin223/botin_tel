...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference("Phone.count") do
      post phones_url, params: { phone: { kind: @phone.kind, number: @phone.number, user_id: @phone.user_id } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { kind: @phone.kind, number: @phone.number, user_id: @phone.user_id } }
